package com.kashif.deepseek.presentation.theme
...
val FuturisticDarkColors = darkColorScheme(
...
val FuturisticLightColors = lightColorScheme(
...
fun AppTheme(
    ...
    CompositionLocalProvider(LocalThemeIsDark provides isDark) {
        val colorScheme = if (isDark.value) FuturisticDarkColors else FuturisticLightColors
        MaterialTheme(
